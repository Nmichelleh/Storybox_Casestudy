...
<section class="showcase">
	...
	<div class="container">
		...
		<form action="/bookDisp" method="get">
				...
				<table   class="content-table" >
					...
					<c:forEach items="${books}" var="books">
						<tr>
							...
							<td>${books.price }</td>
							<c:forEach items="${books.categories}" var="Category">
								<td>${Category.category_name }</td>
							</c:forEach>
							<td><a href="/deleteProduct?id=${books.id }">Delete</a> <a href="/addToCart?id=${books.id}&bookName=${books.bookName }&author=${books.author }&price=${books.price }">Add To Cart</a></td>
						</tr>
					</c:forEach>
				</table>
			</c:otherwise>
...
<div class="menu">
	<ul>
		...
		<li ><a href="/bookDisplay">Products</a></li>
