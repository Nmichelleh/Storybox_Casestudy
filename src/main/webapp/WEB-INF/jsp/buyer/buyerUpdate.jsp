...
<section class="showcase">
	...
	<form method="post" action="/buyer"
		...
		<br/>
			<div class="mb-3">
				<label for="formGroupExampleInput1" class="form-label">
					Buyer First Name </label><br/> <input type="text" class="form-control"
			...
			<div class="mb-3">
				<label for="formGroupExampleInput1" class="form-label">
					Buyer Last Name </label><br/> <input type="text" class="form-control"
		...
		<div class="mb-3">
			<label for="formGroupExampleInput1" class="form-label">
				Business Name </label> <br/><input type="text" class="form-control"
											  id="fexampleFormControlInput1" name="business_name"
		...
		<div class="mb-3">
			<label for="formGroupExampleInput1" class="form-label">
				Buyer Address </label><br/> <input type="text" class="form-control"
